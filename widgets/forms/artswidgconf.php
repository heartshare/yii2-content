...
<?php     $form = ActiveForm::begin(
    [
        ...
        'method' => 'post',
        'action' => \yii\helpers\Url::toRoute(['/content/widget/art-widget-configure', 'id' => $wmodel->id])
    ]
);
?>
<?php
...
$form->field($model, 'category')
    ->dropDownList(\yii\helpers\ArrayHelper::merge([0 => 'Все'], \insolita\content\models\Category::getList()))
